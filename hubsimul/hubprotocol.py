...
class HubProtocol:
    ...
    def sendDiscoveryAck(self,myid):
        if not myid or len(myid) < 4:
            print "sendDiscoveryAck Incorect parameter. myid: %04x"
            return
        self.sendCommand(HubProtocol.ID_REPORT,4,myid)
        ...
        for c in frame:
            ...
            if self.state == 0:
                ...
                if self.calcChecksum == self.rcvchecksum:
                    #print "Received: " , self.opcode, " : ", self.payload
